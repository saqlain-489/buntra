      ...
      >
        <DContainer>
          <div className="flex h-[68px] items-center justify-between">
            <Link href="#top" className={`${display} text-[22px] font-bold tracking-tight text-[color:var(--d-ink)]`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                className="grid h-10 w-10 place-items-center rounded-[var(--d-radius)] text-[color:var(--d-ink)] lg:hidden"
                onClick={() => setOpen((v) => !v)}
          ...
          <div className="border-t border-[var(--d-line)] bg-[var(--d-bg)] lg:hidden">
            <DContainer>
              <div className="flex flex-col gap-1 py-4">
                ...
                <DButton href={hero.primary.href} className="mt-2 w-full" >Free estimate</DButton>
              </div>
            </DContainer>
          </div>
        )}
