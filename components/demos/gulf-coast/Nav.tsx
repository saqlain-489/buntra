      ...
      >
        <DContainer>
          <div className="flex h-[68px] items-center justify-between">
            <Link href="#top" className={`${display} text-[21px] font-bold tracking-tight text-[color:var(--d-ink)]`}>
              Gulf Coast<span className="text-[color:var(--d-accent)]"> Storm Pros</span>
            </Link>
